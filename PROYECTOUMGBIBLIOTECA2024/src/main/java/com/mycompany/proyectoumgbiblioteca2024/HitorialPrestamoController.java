...
public class HitorialPrestamoController implements Initializable {
    ...
    @FXML
    private TableColumn<Prestamo, Integer> IdPrestamo;
    @FXML
   ...
   private Connection conexionBD;
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       IdPrestamo.setCellValueFactory(new PropertyValueFactory<>("idPrestamo"));
    ...
    private void BuscarHistorialdePrestamo(ActionEvent event) {
       ...
       try {
            ...
            while (resultSet.next()) {
                ...
                prestamo.setIdPrestamo(resultSet.getInt("id"));
